...
private:
	...
	void initWindow() {
		...
		//openVideo(resize, flip);
		window = glfwCreateWindow(WIDTH, HEIGHT, "THR34D5 Digital Signature", nullptr, nullptr);
	...
	void SaveOutputColorTexture()
	{
		...
		{
			throw std::runtime_error("failed to create VkImage for image destination!");
		}
